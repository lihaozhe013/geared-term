...
| SES sessions and profiles     | partial            | versioned profile schema, profile list/save/delete IPC, and local profile UI                                                                                | WSL/SSH credential-backed connection flow, import mapping                                     |
