...
| CMD command actions           | partial            | bounded conservative parser, top-level split fallback, and parser fixtures                                                                                  | streaming revision model, copy/insert/run gating, destructive-command confirmation            |
